    ...
    <div className="bg-white px-4">
      <div className="container mx-auto pb-10 sm:pb-16 md:pb-20 xl:pb-[120px]">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-20">
          <Image
            src="/assets/site-images/services/card-one.png"
            alt="card-one"
            width={1000}
            height={1000}
          ...
          <div className="w-full md:w-[560px] flex flex-col gap-4 md:gap-8">
            <h2 className="text-[#1E1D1D]">Space Planning & Design</h2>
            <p className="text-[#474646] mt-2">
              We help transform your vision into a functional and visually
              stunning space. Our experts analyze room dimensions, layout flow,
              lighting, and aesthetic goals to craft a furniture plan that
              maximizes comfort, usability, and style.
            </p>
              ...
              <div className="">
                <ul className="list-disc list-inside">
                  <li className="text-[16px] text-[#474646] leading-[180%]">
                    2D/3D space visualization
                  </li>
                  <li className="text-[16px] text-[#474646] leading-[180%]">
                    Mood boards & material selection
                  </li>
                  <li className="text-[16px] text-[#474646] leading-[180%]">
                    Ergonomic and functional layout plans
                  </li>
                </ul>
              </div>
            </div>
